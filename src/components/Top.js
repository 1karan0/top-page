...
const Top = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row justify-center items-center font-poppins overflow-hidden p-5 lg:p-0">
      <div
        className={`h-full w-full relative p-14 lg:p-16 text-center bg-[#0F1C21] lg:rounded-tr-[150px] lg:rounded-bl-[150px] lg:rounded-br-[0px] lg:rounded-tl-[0px] rounded-[50px] lg:items-start 
    lg:ml-5 lg:w-full lg:h-[600px]
    transition-all duration-600 transform`}
      >
        ...
        <div className={`flex flex-col lg:flex-row justify-center items-center mt-20 gap-7 transition-opacity duration-500 
         `}>
      ...
      {/* Side Elements */}
      <div
        className={`hidden xl:block relative lg:w-2/3 w-[90%]  items-center lg:-ml-3 mt-2 mr-10 transition-all duration-500 transform animate-float-slow `}
      >
        {/* companies logos */}
        {showLogoSection === 0 && (
          <>
            ...
            <div
              className={`absolute top-80 right-10 w-24 lg:w-32 z-40 transition-opacity duration-500 ${
                fadeOut ? "opacity-0" : "opacity-100"
              } animate-float-fast`}
            >
        ...
        {showLogoSection === 1 && (
          <>
            <div
              className={`absolute mt-80 left-7 w-24 lg:w-32 z-40 transition-opacity duration-500 ${
                fadeOut ? "opacity-0" : "opacity-100"
              } animate-float-fast`}
            >
            ...
            <div
              className={`absolute mt-80 -right-5 lg:right-16 w-24 lg:w-32 z-40 transition-opacity duration-500 ${
                fadeOut ? "opacity-0" : "opacity-100"
              } animate-float-fast`}
            >
        ...
        <div className=" bg-[#1dbf73] ml-5 w-full rounded-br-[159px] rounded-tl-[159px] ">
          ...
          <img
            ...
            alt="Job Portal"
            className={`relative left-14 bottom-2 w-3/4  z-20 transition-all duration-500 overflow-hidden
              ${fadeOut ? "opacity-0" : "opacity-100"}
            `}
          />
